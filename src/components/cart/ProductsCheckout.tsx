...
const ProductsCheckout = ({ totalAmount }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-zinc-900 bg-zinc-950/20">
      <div className="flex justify-between border-b border-zinc-900/60 p-2 text-xs">
      ...
      <div className="flex justify-between border-b border-zinc-900 p-2 text-xs mb-3">
